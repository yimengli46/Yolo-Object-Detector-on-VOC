...
# compute TP and FN. Then compute precison and recall. Then call voc_ap to compute mAP.
...
# go through each image and run the trained detection model on them
# run evaluation on the detections.
def evaluate(model, test_dataset_file, test_loader=None):
    ...
    for image_path in tqdm(image_list):
        result = predict_image(model, image_path, root_img_directory='VOCdevkit_2007/VOC2007test/JPEGImages/')
